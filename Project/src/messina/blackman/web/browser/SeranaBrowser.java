package messina.blackman.web.browser;
...
public class SeranaBrowser extends JFrame {
	...
	private void initComponents() {
		...
		Icon icon = new ImageIcon("C:\\Users\\SDD1\\Downloads\\settings.png");
		...
		JPanel topBarSubRight = new JPanel();
		topBarSubRight.add(btnGo);
		topBarSubRight.add(settings);
		...
		topBar.add(topBarSubRight, BorderLayout.EAST);
						...
						new ChangeListener<String>() {
							...
							public void changed(
								...
								SwingUtilities.invokeLater(new Runnable() {
									@Override
									public void run() {
										SeranaBrowser.this.setTitle(newValue);
									}
								});
							}
						});
	...
	public static void main(String[] args) {
		try {
			...
			JOptionPane.showMessageDialog(null, "Could not change LookAndFeel");
		}
		SwingUtilities.invokeLater(new Runnable() {
			
			public void run() {
				SeranaBrowser browser = new SeranaBrowser();
